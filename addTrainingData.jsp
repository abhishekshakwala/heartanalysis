...
<title>Heart Analysis - Add Training Data</title>
</head>
<body>
<div class="center">
<h1 class="Heading">Add Training Data</h1>
</br>
<form enctype="multipart/form-data" method="post" action="addTrainingDataProcess.jsp">
<center>
<table border="2" >
